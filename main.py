...
class PreprocessImageDataset(object):
    def __init__(self):
        ...
        self.words_count = 0
        self.chars_count = 0
        self.tobe_proceed = ['4.jpg'] #ganti gambar dri folder dataset
    ...
    def preprocessor(self):
        for root, dirs, files in os.walk("dataset"):
            for file in files:
                ...
                thinning_image = self._thining_image(dilated_img)

                centered_img = self._deskew(thinning_image, file)
